...
const correctPowerBWith3P4L = (data, args) => {
  ...
  if (data[args[0]] === 0) {
    if (data[args[4]][1].slice(0,1) === '-') {
      correctPowerB[0] = -1 * data[args[1]][1] * data[args[2]][0] * Math.cos(data[args[3]][0] - 120.0)
      correctPowerB[1] = -1 * data[args[5]][1]
      correctPowerB[2] = -1 * data[args[1]][1] * data[args[2]][2] * Math.cos(data[args[3]][2] - 120.0)
    } else {
    ...
    if (data[args[4]][1].slice(0,1) === '-') {
      correctPowerB[0] = -1 * data[args[1]][1] * data[args[2]][0] * Math.cos(data[args[3]][0] - 240.0)
      correctPowerB[1] = -1 * data[args[5]][1]
      correctPowerB[2] = -1 * data[args[1]][1] * data[args[2]][2] * Math.cos(data[args[3]][2] - 240.0)
    } else {
...
const correctPowerCWith3P4L = (data, args) => {
  ...
  if (data[args[0]] === 0) {
    if (data[args[4]][2].slice(0,1) === '-') {
      correctPowerC[0] = -1 * data[args[1]][2] * data[args[2]][0] * Math.cos(data[args[3]][0] - 240.0)
      correctPowerC[1] = -1 * data[args[1]][2] * data[args[2]][1] * Math.cos(data[args[3]][1] - 240.0)
    ...
    if (data[args[4]][2].slice(0,1) === '-') {
      correctPowerC[0] = -1 * data[args[1]][2] * data[args[2]][0] * Math.cos(data[args[3]][0] - 120.0)
      correctPowerC[1] = -1 * data[args[1]][2] * data[args[2]][1] * Math.cos(data[args[3]][1] - 120.0)
      correctPowerC[2] = -1 * data[args[5]][2]
    } else {
...
const correctPowerAWith3P3L = (data, args) => {
  ...
  if (data[args[0]] === 0) {
    ...
    if (data[args[4]][2].slice(0, 1) === '-') {
      ...
      correctPowerA[2] = {
        UcaL1: -1 * (data[args[1]][0] + data[args[1]][2]) * 0.5 * data[args[2]][0] * Math.cos(270 - data[args[3]][0]),
        UcaL2: -1 * (data[args[1]][0] + data[args[1]][2]) * 0.5 * data[args[2]][2] * Math.cos(270 - data[args[3]][1])
      }
    } else {
      correctPowerA[1] = {
      ...
      correctPowerA[2] = {
        UcaL1: (data[args[1]][0] + data[args[1]][2]) * 0.5 * data[args[2]][0] * Math.cos(270 - data[args[3]][0]),
        UcaL2: (data[args[1]][0] + data[args[1]][2]) * 0.5 * data[args[2]][2] * Math.cos(270 - data[args[3]][1])
      }
    }
  } else {
    if (data[args[4]][0].slice(0,1) === '-') {
      correctPowerA[0] = {
        UacL1: -1 * (data[args[1]][0] + data[args[1]][2]) * 0.5 * data[args[2]][0] * Math.cos(330 - data[args[3]][0]),
        UacL2: -1 * (data[args[1]][0] + data[args[1]][2]) * 0.5 * data[args[2]][2] * Math.cos(330 - data[args[3]][1])
      }
      correctPowerA[1] = {
        UbaL1: data[args[5]][0],
      ...
      correctPowerA[0] = {
        UacL1: (data[args[1]][0] + data[args[1]][2]) * 0.5 * data[args[2]][0] * Math.cos(330 - data[args[3]][0]),
        UacL2: (data[args[1]][0] + data[args[1]][2]) * 0.5 * data[args[2]][2] * Math.cos(330 - data[args[3]][1])
      }
      correctPowerA[1] = {
...
const correctPowerBWith3P3L = (data, args) => {
  ...
  if (data[args[0]] === 0) {
    ...
    if (data[args[4]][2].slice(0,1) === '-') {
      ...
      correctPowerA[1] = {
        UcaL1: -1 * (data[args[1]][0] + data[args[1]][2]) * 0.5 * data[args[2]][0] * Math.cos(270.0 - data[args[3]][0]),
        UcaL2: -1 * (data[args[1]][0] + data[args[1]][2]) * 0.5 * data[args[2]][2] * Math.cos(270.0 - data[args[3]][1])
      } 
    } else {
      correctPowerA[0] = {
      ...
      correctPowerA[1] = {
        UcaL1: (data[args[1]][0] + data[args[1]][2]) * 0.5 * data[args[2]][0] * Math.cos(270.0 - data[args[3]][0]),
        UcaL2: (data[args[1]][0] + data[args[1]][2]) * 0.5 * data[args[2]][2] * Math.cos(270.0 - data[args[3]][1])
      } 
    }
    if (data[args[4]][0].slice(0, 1) === '-') {
      correctPowerA[2] = {
